...
function Admin() {
  ...
  const addAlbumHandler = (e) => {
    ...
    // Backend expects image field; ensure this matches your multer config
  ...
  const addSongHandler = (e) => {
    ...
    // Backend expects audio field; ensure this matches your multer config
    formData.append("file", file);
          ...
          {songs &&
            songs.map((e, i) => (
              <div key={i} className="bg-[#181818] p-4 rounded-lg shadow-md">
                {e.thumbnail ? (
                  <img src={e.thumbnail.url} alt="" className="mr-1 w-52 h-52" />
                ) : (
